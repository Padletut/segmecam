...
void ApplyPreset(int idx, BeautyState& s) {
  switch (idx) {
    case 0: // Default
      ...
      s.fx_skin_wrinkle = true; s.fx_skin_smile_boost = 0.5f; s.fx_skin_squint_boost = 0.5f; s.fx_skin_wrinkle_gain = 1.0f; s.fx_skin_smile_wrinkle_gain = 0.8f; s.fx_skin_forehead_boost = 0.8f;
    ...
    case 1: // Natural
      ...
      s.fx_skin_wrinkle = true; s.fx_skin_wrinkle_gain = 0.8f; s.fx_skin_smile_wrinkle_gain = 0.2f; s.fx_skin_smile_boost = 0.4f; s.fx_skin_squint_boost = 0.4f; s.fx_skin_forehead_boost = 0.7f;
    ...
    case 2: // Studio
      ...
      s.fx_skin_wrinkle = true; s.fx_skin_wrinkle_gain = 0.6f; s.fx_skin_smile_wrinkle_gain = 0.6f; s.fx_skin_smile_boost = 0.55f; s.fx_skin_squint_boost = 0.5f; s.fx_skin_forehead_boost = 0.9f;
    ...
    case 3: // Glam
      ...
      s.fx_skin_wrinkle = true; s.fx_skin_wrinkle_gain = 0.4f; s.fx_skin_smile_wrinkle_gain = 0.55f; s.fx_skin_smile_boost = 0.55f; s.fx_skin_squint_boost = 0.55f; s.fx_skin_forehead_boost = 1.0f;
    ...
    case 4: // Meeting
      ...
      s.fx_skin_wrinkle = true; s.fx_skin_wrinkle_gain = 0.2f; s.fx_skin_smile_wrinkle_gain = 0.45f; s.fx_skin_smile_boost = 0.45f; s.fx_skin_squint_boost = 0.45f; s.fx_skin_forehead_boost = 0.8f;
