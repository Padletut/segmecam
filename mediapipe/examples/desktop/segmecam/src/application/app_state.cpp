...
void AppState::SaveToProfile(cv::FileStorage& fs) const {
  ...
  fs << "show_landmarks" << (int)show_landmarks << "lm_roi_mode" << (int)lm_roi_mode << "lm_apply_rot" << (int)lm_apply_rot
      ...
      << "show_facemask" << (int)show_facemask << "show_wrinkle_segmentation" << (int)show_wrinkle_segmentation
      << "show_wrinkle_inpaint" << (int)show_wrinkle_inpaint;
...
void AppState::LoadDisplaySettings(const cv::FileNode& root) {
  ...
  show_wrinkle_segmentation = ReadInt(root["show_wrinkle_segmentation"], show_wrinkle_segmentation);
  show_wrinkle_inpaint = ReadInt(root["show_wrinkle_inpaint"], show_wrinkle_inpaint);
}
